...
![Windows forms AutoComplete drag and drop from toolbox](../images/AutoComplete_Toolbox.png)

![Windows forms AutoComplete and Textbox with component tray](../images/AutoComplete_Inform.png)
...
2. Add the required namespace and create an instance for AutoComplete and TextBox controls.
...
![Windows forms AutoComplete toolbox customization](../images/Autocomplete_Propertywindow.png)
...
![Windows forms AutoComplete with binding data source](../images/AutoComplete_datasourceform.png)
